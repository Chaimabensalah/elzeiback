	   ...
	   public ClientService ClientService;
	    ...
	    public Client get(@PathVariable("id") int id) {
		 ...
		 @ResponseBody
		    ...
		    public ResponseEntity<String> update(@PathVariable("id") int id, @RequestBody Client updatClient) {
			...
			Client existingClient = ClientService.findById( id);
		        ...
		        ClientService.save(updatClient);
		        return new ResponseEntity<>("client updatedd successfully", HttpStatus.OK);
		    }
